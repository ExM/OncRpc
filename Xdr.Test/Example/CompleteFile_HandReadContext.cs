...
{
	public class CompleteFile_HandReadContext
	{
		...
		private CompleteFile_HandReadContext(IReader reader, Action<CompleteFile> completed, Action<Exception> excepted)
		{
			_reader = reader;
		...
		{
			new CompleteFile_HandReadContext(reader, completed, excepted);
		}
	}
}
